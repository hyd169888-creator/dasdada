                ...
                <div class="page-section active" id="pageEngine">
                    ...
                    <div class="card" style="z-index: 40;">
                                ...
                                <div class="custom-select" id="select-provider" data-value="{{PROVIDER_VAL}}">
                                    ...
                                    <div class="select-dropdown" style="height: 180px;">
                                        ...
                                        <div class="select-scroll-viewport" onscroll="updateScroll('select-provider', 'thumb-provider')">
                                            ...
                                            <div class="select-option" data-value="DeepSeek" onclick="selectOption('select-provider', 'DeepSeek', 'DeepSeek (官方直直连·深度思考)')">DeepSeek (官方直连·深度思考)</div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-field"><input type="text" id="baseUrl" class="input-box" value="{{BASE_URL}}" /></div>
                        </div>
                        <div class="form-row">
                            <div class="form-label">Model Name</div>
                            <div class="form-field"><input type="text" id="model" class="input-box" value="{{MODEL_NAME}}" /></div>
                        </div>
                        <div class="form-row">
                            <div class="form-label">API Key</div>
                            <div class="form-field"><input type="password" id="apiKey" class="input-box" value="{{API_KEY}}" /></div>
                        </div>
                    </div>
                    <div class="lime-card">
